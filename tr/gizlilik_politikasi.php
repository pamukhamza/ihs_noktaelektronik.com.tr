...
$currentPage = 'gizlilik_politikasi';
$template = new Template('Nokta - Gizlilik Politikası', $currentPage);
...
<section class="container mb-5">
    <div class="row">
        ...
        <div class="float-end col-xs-12 col-sm-8 col-md-9 rounded-3 ">
            <?php $row = $database->fetch("SELECT * FROM documents WHERE `type` = 'gizlilik' AND `site` = 'b2b'"); ?>
