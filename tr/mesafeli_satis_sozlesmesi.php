...
$currentPage = 'mesafeli_satis_sozlesmesi';
$template = new Template('Nokta - Mesafeli Satış Sözleşmesi', $currentPage);
...
<section class="container mb-5">
    <div class="row">
        ...
        <div class="float-end col-xs-12 col-sm-8 col-md-9 rounded-3 ">
            <?php $row = $database->fetch("SELECT * FROM documents WHERE `type` = 'mesafeli_satis_sozlesmesi' AND `site` = 'b2b'"); ?>
