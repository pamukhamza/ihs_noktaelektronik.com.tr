                    ...
                    <form id="applicationForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" class="form-control" id="musteri_id" hidden value="<?php if($_SESSION('id')){ $_SESSION['id'];} ?>">
                                <input type="text" class="form-control" id="musteri" value="<?= $_SESSION['firma']; ?>" readonly>
